...
import { UploadZone } from './UploadZone-simple';
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-background text-foreground">
      ...
      <div 
        ...
        style={{ 
          background: 'radial-gradient(ellipse at top, hsl(238, 84%, 67%, 0.15), transparent 50%)'
        }}
      />
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">
              ...
              <span 
                ...
                style={{ 
                  backgroundImage: 'linear-gradient(135deg, hsl(238, 84%, 67%), hsl(280, 84%, 60%))'
                }}
              >
                CSV data
              </span>
